...
class SingleLinkedList{
	...
	void deleteDataFromList(int data){
		...
		System.out.println("Linked list will be: ");
		printLL();
	}
...
class Client{
	public static void main(String [] args){
		...
		do{
			...
			System.out.println("9.deleteDataFromList");
			...
			switch(choice){
				...
				case 8:
					...
					break;
				case 9:
					System.out.println("Enter data to be deledted in the List: ");
					sll.deleteDataFromList(sc.nextInt());
					break;
				default:
