...
class SingleLinkedList{
	...
	int  lengthOfLoop(int index){
		if(countNode()==index)
			return 0;
		else if(index>countNode() || index<1){
			System.out.println("Invaild index");
			return -1;
		}
		else{
			return countNode()-index+1;
		}
	}
}
class Client{
	public static void main(String [] args){
		...
		do{
			...
			System.out.println("9.lengthOfLoop");
			...
			switch(choice){
				...
				case 9:
					...
					System.out.println("length of loop is: "+sll.lengthOfLoop(sc.nextInt()));
					break;
				default:
