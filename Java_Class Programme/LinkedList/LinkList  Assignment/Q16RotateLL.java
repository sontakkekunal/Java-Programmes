...
class SingleLinkedList{
	...
	void rotateKtimeLefttoRight(int k){
		if(head==null){
			System.out.println("List is empty: ");
			return;
		}
		else if(k>countNode()){
			System.out.println("Ivalid k to rotate list");
			return;
		}
		while(k!=0){
			Node temp=head.next;
		...
		System.out.println("Rotated lis is: ");
		printLL();
	}
...
class Client{
	public static void main(String [] args){
		...
		do{
			...
			System.out.println("9.rotateKtimeLefttoRight");
			...
			switch(choice){
				...
				case 8:
					...
					break;
				case 9:
					System.out.println("Enter how many time to rotate LL: ");
					int k=sc.nextInt();
					sll.rotateKtimeLefttoRight(k);
					break;
				default:
