...
class SingleLinkedList{
	...
	void reverseRec(Node previous,Node current){
		if(current==null){
			System.out.println("List reversed succesfullty");
			head=previous;
			return;
		}
...
class Client{
	public static void main(String [] args){
		...
		do{
			...
			System.out.println("9.reverseRec");
